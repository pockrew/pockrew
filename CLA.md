...
> **This document is not legal advice and was not drafted by a lawyer.** It is adapted from the
> Apache Software Foundation Individual Contributor License Agreement v2.2, which is the most widely
> used agreement of its kind, with the Foundation-specific clauses replaced. Have a lawyer review it
> before relying on it commercially.

Thank you for your interest in Pockrew. To clarify the intellectual property license granted with
Contributions from any person or entity, Đàm Hưng Thịnh ("the Maintainer") must have a record of
your agreement with the terms below. This agreement protects you as a Contributor as much as it
protects the Maintainer and users of the project. It does not change your rights to use your own
Contributions for any other purpose.

## Why this exists

Pockrew is released under FSL-1.1-MIT and there are plans for a paid, closed-source surface built on
the same code. Distributing your Contribution under those terms requires a license from you broad
enough to sublicense. Without it, no one — including the Maintainer — could legally ship your code
in the project. Being explicit about this up front is better than discovering it later.

**You keep the copyright to your Contributions.** This is a license, not an assignment. You may
relicense, sell, or republish your own work however you like.

## How to sign

Add a line to the description of your first pull request:
...
That, plus the public record of the pull request, is the agreement. One signature covers all your
future Contributions.

## Terms

You accept and agree to the following terms and conditions for Your present and future
Contributions submitted to Pockrew. Except for the license granted herein to the Maintainer and
recipients of software distributed by the Maintainer, You reserve all right, title, and interest in
...
documentation of, any of the products owned or managed by the Maintainer (the "Work"). For the
purposes of this definition, "submitted" means any form of electronic, verbal, or written
communication sent to the Maintainer or their representatives, including but not limited to
communication on electronic mailing lists, source code control systems, and issue tracking systems
that are managed by, or on behalf of, the Maintainer for the purpose of discussing and improving the
...
grant to the Maintainer and to recipients of software distributed by the Maintainer a perpetual,
...
**4. Sublicensing and relicensing.** You understand and agree that the Maintainer may distribute Your
Contributions under FSL-1.1-MIT, under the MIT license once a release converts, and under other
licenses, including proprietary or commercial licenses, as part of the Work or a product derived
from it. The rights granted in sections 2 and 3 exist so that this is possible.

**5. You represent that you are legally entitled to grant the above license.** If your employer(s)
...
employer has waived such rights for your Contributions to the Maintainer, or that your employer has
executed a separate agreement with the Maintainer.

**6. You represent that each of Your Contributions is Your original creation** (see section 8 for
...
Signing this does not make your work anonymous. Git history preserves your authorship, and
substantial contributions are credited in the release notes.
